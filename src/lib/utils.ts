...
export const PARAMETRIC_MODELS: ModelConfig[] = [
  ...
  {
    id: 'openai/deepseek-v4.1-flash',
    name: 'DeepSeek V4.1 Flash (Ollama Cloud)',
    description: 'Fast DeepSeek mixture-of-experts model at low cost',
    provider: 'DeepSeek',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: false,
  ...
  {
    id: 'openai/glm-5.3-flash',
    name: 'GLM 5.3 Flash (Ollama Cloud)',
    description: 'Fast, low-cost Z.AI model for everyday CAD work',
    provider: 'Z.AI',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: true,
  ...
  {
    id: 'openai/kimi-k2.7-code',
    name: 'Kimi K2.7 Code (Ollama Cloud)',
    description: 'Moonshot AI coding-focused model via Ollama Cloud',
    provider: 'Moonshot AI',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: false,
  ...
  {
    id: 'openai/deepseek-v4-pro:0813',
